...
/* video 4 */
static PyObject* method_selam3(PyObject* self, PyObject* args){
    const char* isim;
    if(!PyArg_ParseTuple(args, "s", &isim)){
        return NULL;
    }
    printf("Selam %s,artık C katmanındasın\n",isim);
    Py_RETURN_NONE;
}

/* video 5 */
static PyObject* method_selam4(PyObject* self, PyObject* args){
    int n=10;
...
static PyMethodDef UmitMethods[] = {
    ...
    {"umt_selam3",method_selam3,METH_VARARGS, "string parametreli selam 3 fonksiyonu."},
    {"umt_selam4",method_selam4,METH_VARARGS, "integer parametreli selam 4 fonksiyonu."},
    {NULL,NULL,0,NULL}
};
