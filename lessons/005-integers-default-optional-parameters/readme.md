...
- **Optional Parameters:** Discovering how to add default values ​​and optional parameters to functions using the Pipe (|) operator.
- **Practical Example:** Writing a Python extension of a C-based function that calculates the sum of numbers using a loop.
